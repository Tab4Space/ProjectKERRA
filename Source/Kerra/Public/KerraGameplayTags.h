...
namespace KerraGameplayTags
{
	...
	/* Quest Tags */
	KERRA_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Quest_ID_FirstQuest);
	KERRA_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Quest_ID_SecondQeust);
	KERRA_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Quest_ID_ThirdQuest);

	/* Item Tags */
	KERRA_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_ID_Apple);
	KERRA_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_ID_Banana);
	KERRA_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_ID_Orange);
