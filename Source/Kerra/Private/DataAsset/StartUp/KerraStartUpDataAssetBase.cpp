...
void UKerraStartUpDataAssetBase::GiveToAbilitySystemComponent(UKerraAbilitySystemComponent* InASC, int32 InApplyLevel)
{
...
void UKerraStartUpDataAssetBase::GrantAbilities(const TArray<TSubclassOf<UKerraGameplayAbility>>& InAbilitiesToGive, UKerraAbilitySystemComponent* InASC, int32 InApplyLevel)
{
